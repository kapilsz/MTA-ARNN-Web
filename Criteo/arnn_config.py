#Customize Config
class config1:
    def __init__(self, max_features, learning_rate, embed_feature_number, non_embed_feature_number, batch_size, feature_number, seq_max_len, embedding_output, n_hidden,
        ...
        self._embed_feature_number = embed_feature_number
        self._non_embed_feature_number = non_embed_feature_number
        self._n_hidden = n_hidden
        self._n_classes = n_classes
        if n_input:
            self._n_input = n_input + embed_feature_number * embedding_output
        else:
    ...
    @property
    def embed_feature_number(self):
        return self._embed_feature_number
    
    @property
    def non_embed_feature_number(self):
        return self._non_embed_feature_number